...
fun ParentProfileScreen() {
    Column(
        ...
        val listaDocentes = listOf(
            "Miss Alejandra Hernández" to R.drawable.parent,
            "Profesor Pablo Ramos" to R.drawable.parent,
            "Docente María López" to R.drawable.parent
        )

        listaDocentes.forEach {
            ProfileListItem(name = it.first, avatarRes = it.second)
            Spacer(modifier = Modifier.height(6.dp))
        }
    }
